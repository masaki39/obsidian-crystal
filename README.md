...
| コマンド | 機能 | 説明 |
|---|---|---|
| `Gamification: Open stats view` | 統計ビューを開く | サイドバーにレベル/XPバー、次の称号までの距離、今日のタスク進捗、7日間・30日間のXP推移、累計統計、自己ベスト記録（最長ストリーク・1日の最多タスク・週間最高XP）、称号一覧をまとめて表示する。リボンアイコンまたはステータスバーのクリックからも開ける。 |
